...
export const CharityDialog = ({ onOpen, onClose, data }) => {
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>{data.taxid}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>{data.isBlocked ? "Blocked" : "Unblocked"}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>{data.subtitle}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>No. of Buildings</TableCell>
                      <TableCell>{data.Noofbuildings}</TableCell>
                    </TableRow>
                    <TableRow>
